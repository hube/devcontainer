...
require 'does not run `gh auth setup-git`' "$README"
require 'SSH agent forwarding' "$README"
require 'minimum scopes' "$README"
require '`gh auth logout --hostname github.com`' "$README"
require '`docker volume rm github-cli-config-<devcontainerId>`' "$README"
