...
- Cover the missing-`gh` startup path in the hermetic tests, and document in the NOTES and design: credential scope (`gh` subcommands only, no `gh auth setup-git`), classic-token minimum scopes, and stale stored-token removal.
...
- [x] **Step 1: Write failing wrapper-level tests**
...
- [x] **Step 2: Run the hook suite and verify RED**
...
- [x] **Step 3: Capture diagnostics and implement specific warnings**
...
- [x] **Step 5: Synchronize and commit**
...
- [x] **Step 1: Write failing documentation and parser tests**
...
- [x] **Step 3: Implement JSONC parsing without dependencies**
...
- [x] **Step 4: Rename and revise documentation**
...
- [x] **Step 5: Reorder configuration and synchronize status**
